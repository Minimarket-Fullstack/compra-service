...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        DetalleCompra d1A = new DetalleCompra(
            null,
            c1,
            1L,
            "Arroz 1kg",
        ...
        DetalleCompra d1B = new DetalleCompra(
            null,
            c1,
            2L,
            "Fideos 500g",
        ...
        DetalleCompra d2A = new DetalleCompra(
            null,
            c2,
            3L,
            "Leche 1L",
        ...
        DetalleCompra d2B = new DetalleCompra(
            null,
            c2,
            4L,
            "Yogurt 200g",
        ...
        DetalleCompra d3A = new DetalleCompra(
            null,
            c3,
            5L,
            "Queso Laminado",
        ...
        DetalleCompra d4A = new DetalleCompra(
            null,
            c4,
            6L,
            "Papas Fritas 200g",
        ...
        DetalleCompra d4B = new DetalleCompra(
            null,
            c4,
            7L,
            "Galletas 300g",
        ...
        DetalleCompra d5A = new DetalleCompra(
            null,
            c5,
            8L,
            "Detergente 1kg",
        ...
        DetalleCompra d6A = new DetalleCompra(
            null,
            c6,
            9L,
            "Pan Molde",
        ...
        DetalleCompra d7A = new DetalleCompra(
            null,
            c7,
            10L,
            "Tomates 1kg",
        ...
        DetalleCompra d7B = new DetalleCompra(
            null,
            c7,
            1L,
            "Papas 1kg",
